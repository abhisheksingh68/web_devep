...
<body>
    ...
    <hr>
    <br>
    <form action="handle-p14.php" method="POST">
        <p>Enter the Marks of 1st Subject : </p>
        <input type="number" name="sub1" id="sub1">
        <br><br>
        <p>Enter the Marks of 2nd Subject : </p>
        <input type="number" name="sub2" id="sub2">
        <br><br>
        <p>Enter the Marks of 3rd Subject : </p>
        <input type="number" name="sub3" id="sub3">
        <br><br>
        <p>Enter the Marks of 4th Subject : </p>
        <input type="number" name="sub4" id="sub4">
        <br><br>
        <p>Enter the Marks of 5th Subject : </p>
